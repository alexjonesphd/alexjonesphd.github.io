...
description: "Ten books (plus a few) that helped me learn Bayesian inference from scratch, coming from a frequentist background."
date: 2022-07-06
categories: [Bayesian, books, learning]
image: bayes_book.jpg
---
...
## 1. Bayesian Statistics The Fun Way {.unnumbered}
...
## 2. Bayesian Statistics for Beginners: A step-by-step approach {.unnumbered}
...
## 3. Bayes Rules! An introduction to applied Bayesian Modelling {.unnumbered}
...
## 4. Statistical Rethinking, Second Edition {.unnumbered}
...
## 5. Doing Bayesian Data Analysis {.unnumbered}
...
## 6. Bayesian Methods in Statistics: From Concepts to Practice {.unnumbered}
...
## 7. Bayesian Analysis with Python, Second Edition {.unnumbered}
...
## 8. Bayesian Modeling and Computation in Python {.unnumbered}
...
## 9. A Student's Guide to Bayesian Statistics {.unnumbered}
...
## 10. Bayesian Data Analysis, 3rd Edition {.unnumbered}
...
## Other notable mentions {.unnumbered}
